...
class Ali:public info{
	public:
		...
		void get()
		{
			...
			a1.get();
			out.write(reinterpret_cast<char *>(&a1),sizeof(info));
			out.close();
...
class Sara:public info{
	...
	void get(){
			system("cls");
			ofstream out("Sara.txt",ios::app|ios::binary);
			a1.get();
			out.write(reinterpret_cast<char *>(&a1),sizeof(info));
			out.close();
			cout<<"***YOUR INFORMATION  HAS BEEN SAVED*** \n\t\t\tPress any Key to Continue  ";
...
class Alishba:public info{
	...
	void get(){
			system("cls");
			ofstream out("Alishba.txt",ios::app|ios::binary);
			a1.get();
			out.write(reinterpret_cast<char*>(&a1),sizeof(info));
			out.close();
			cout<<"***YOUR INFORMATION  HAS BEEN SAVED*** \n\t\t\tPress any Key to Continue  ";
...
cout<<"\t6-\t\tPress 6 For checking staff Information menu:   \n\n";
cout<<"\t7-\t\tPress 7 For change password or create password:   \n\n";
cout<<"\t8-\t\t [    press 8 for logout and Exit    ]                    \n";
